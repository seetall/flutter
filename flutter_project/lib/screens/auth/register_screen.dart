                  ...
                  children: [
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              image: DecorationImage(
                                  image: AssetImage('assets/images/hehhe-01-01-01.jpeg'),
                                  fit: BoxFit.cover
                              )
                          ),
                        )),
                    ...
                    Column(
                      children: [
                        SizedBox(height: 80,),
                        Text("Sign Up",
                          style: const TextStyle(fontFamily: 'Lato', fontSize: 30.0, color: Colors.blueGrey, fontWeight: FontWeight.bold),
                        ),
                        SizedBox(height: 10,),
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: 'First Name',
                            hintStyle:
                            TextStyle(fontFamily: 'Lato', fontSize: 17.0),
                          ),
                        ),
                        SizedBox(height: 10,),
                        TextFormField(
